                        ...
                        <div class="d-flex justify-content-between mb-3">
                            <div class="">
                                @if(request('keyword'))
                                    ...
                                    <a class="ms-3" href="{{ route('post.index') }}">
                            ...
                            @forelse($posts as $post)
                                <tr>
                                    ...
                                    <td class="text-nowrap text-center">
                                        <a class="btn btn-outline-info btn-sm" href="{{ route('post.show',$post->id) }}">
                                            <i class="bi bi-info-circle"></i>
                                        </a>
                                        @can('update',$post)
                                        <a class="btn btn-outline-warning btn-sm" href="{{ route('post.edit',$post->id) }}">
                                ...
                                @empty
                                <tr>
                                    <td class="text-center" colspan="6">There's no post</td>
                                </tr>
